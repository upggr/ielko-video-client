...
add_submenu_page('edit.php?post_type=media_item', __('Test Settings','menu-test'), __('Test Settings','menu-test'), 'manage_options', 'ielko_wp_media_manager', 'ivc_options_page' );
