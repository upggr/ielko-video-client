...
imagettftext($imagetobewatermark, $fontsize, 300, 300, 10, $white, $font, $watermarktext);
...
$captions = array();
if($theimg === null) {
	$theimg = 'http://ielko-video-client.upg.gr/?feed=gen_img&wi=800&orig=http://greektv.upg.gr/default.png&he=450&txt='.$thetitle;
